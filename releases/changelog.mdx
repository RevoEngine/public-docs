...
<Card title="Latest · 1.5.8 — Safer component changes and clearer operational evidence" icon="sparkles" href="/changelog/1.5.8">
  2026-09-20. RevoEngine 1.5.8 catches more low-code problems before a change is saved, keeps large database operations complete inside their original transaction and connects operational failures to clearer evidence. It also strengthens Assistant change review and makes busy Jobs and Trace views more useful without adding noise to the main workflow.
</Card>
