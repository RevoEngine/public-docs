...
<Card title="Latest · 1.5.6 — Clearer Assistant progress, dependable attachments and typed transfers" icon="sparkles" href="/changelog/1.5.6">
  2026-09-16. RevoEngine 1.5.6 improves everyday Assistant work, file delivery and integration authoring. Plans follow review feedback without requiring matching wording, files keep their normal access rules across workspaces, and notification emails share a consistent layout with direct download actions.
</Card>
