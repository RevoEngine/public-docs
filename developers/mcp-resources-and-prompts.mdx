...
Direct MCP calls use the authenticated client's platform authority. They do not pause for Assistant approval; clients must not assume that an approval step described in an Assistant workflow protects an MCP mutation.
