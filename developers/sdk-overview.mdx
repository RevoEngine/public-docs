...
```bash
npm install @revoengine/sdk@1.5.6
```
...
SDK 1.5.6 matches the RevoEngine 1.5.6 platform contract. Newly created hosted Components use this exact SDK version; existing deployed revisions retain their recorded version until redeployed with an updated configuration.
