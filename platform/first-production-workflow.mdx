...
<CardGroup cols={2}>
  ...
  <Card title="HTTP integrations" icon="cloud-arrow-up" href="/low-code/http">
    Integrate JSON APIs, multipart forms, SSE, byte streams, callbacks, and Storage transfers.
  </Card>
</CardGroup>
