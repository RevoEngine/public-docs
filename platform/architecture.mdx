...
flowchart TB
    ...
    Admission --> Execute["Endpoint · Sandbox · Job · Assistant · Agent"]
...
- Assistant and Agent turns use a governed tool loop over platform capabilities.
