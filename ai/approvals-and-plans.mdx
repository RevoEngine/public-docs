...
Eligible changes explicitly requested by the user can receive an automatic review. The conversation distinguishes automatic approval, manual approval and a return to manual review, with an explanation of the outcome. Unclear intent, insufficient evidence or a stale proposal does not silently become approval.
