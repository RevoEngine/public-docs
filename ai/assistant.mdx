...
| --- | --- | --- | --- |
| **GPT-5.6 Sol** | Supported | Supported | Not available |
| **GPT-5.6 Terra** | Supported | Supported | Not available |
| **GPT-5.6 Luna** | Supported | Supported | Optional for interactive Assistant work |

Select Luna's lightning control when lower response latency matters for the current conversation. Standard remains the normal path when Fast Mode is not selected, and the option is not shown for other models. Autonomous Agent runs use Standard processing. Usage analytics distinguishes the actual Standard and Fast execution used by each Assistant call.
