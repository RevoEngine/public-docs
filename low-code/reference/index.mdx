...
| --- | ---: | --- |
| [`api`](/low-code/reference/api) | 71 | Execution, platform, Database, HTTP, automation, and compatibility methods. |
...
| [`transport`](/low-code/reference/transport) | 3 | Storage-only protocol adapters with Secret-backed connections. |
