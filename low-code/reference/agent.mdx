...
<span id="agent-getThreadGoal" aria-hidden="true"></span>
...
<span id="agent-setThreadGoal" aria-hidden="true"></span>
...
<span id="agent-pauseThreadGoal" aria-hidden="true"></span>
...
<span id="agent-resumeThreadGoal" aria-hidden="true"></span>
...
<span id="agent-clearThreadGoal" aria-hidden="true"></span>
