...
This historical example uses the method name available in 1.3.1. For new code, use `api.getDatabaseData()` with a View name; the older name is now deprecated.
