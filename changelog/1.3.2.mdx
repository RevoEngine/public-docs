...
This historical example uses the method name available in 1.3.2. For new code, use `transport.sftpImport()` with a Secret-backed connection; the older name is now deprecated.
